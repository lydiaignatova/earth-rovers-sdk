...
tmux send-keys -t frodobot:0.2 'python lydia_teleop.py' C-m
...
# tmux send-keys -t frodobot:03 'python lydia_recorder.py --data_save_dir /home/lydia/data/frodobot/supervised' C-m 
